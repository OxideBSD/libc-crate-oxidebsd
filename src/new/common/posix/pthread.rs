...
extern "C" {
    ...
    #[cfg(any(target_os = "android", target_os = "l4re", target_os = "linux", target_os = "oxidebsd"))]
    ...
    #[cfg(any(target_os = "l4re", target_os = "linux",
        target_os = "oxidebsd", target_vendor = "apple"))]
    ...
    #[cfg(any(target_os = "l4re", target_os = "oxidebsd", all(target_os = "linux", not(target_env = "ohos"))))]
    ...
    #[cfg(any(target_os = "oxidebsd", all(target_os = "linux", not(target_env = "ohos"))))]
    ...
    #[cfg(any(target_os = "l4re", target_os = "linux", target_os = "oxidebsd"))]
